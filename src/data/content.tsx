...
export const footerBannerData = {
  heading: "Bienvenue à MiniJaba le meilleur du rapport qualité prix",
  description:
    "View all brands of our collection on MiniJaba, there is another collection. Please check it out bro, like seriously",
};

export const footerData = {
  description:
    "Merci de tout cœur d'avoir choisi Minijaba pour votre expérience de shopping. Fondée en 2025, notre mission est de vous offrir le meilleur du shopping au Sénégal et de vous accompagner avec passion et soin dans chaque étape de votre achat. Nous sommes honorés de faire partie de votre quotidien et de contribuer à vous proposer des produits de hautes qualités.",
  footerLinks: [
    {
      title: "Main Pages",
      links: [
...
export const newsletter = {
  heading: "Au revoir sur MiniJaba",
  description:
    "Drop your email below and start receiving the best offers from MiniJaba",
};
  ...
  directContactInfo: [
    {
      ...
      contactLink: {
        href: "mailto:sales@MiniJaba.com",
        title: "sales@MiniJaba.com",
      },
    },
    {
